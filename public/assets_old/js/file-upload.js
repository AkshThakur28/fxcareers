...
(function ($) {
    ...
    $.fn.fileUpload = function () {
        return this.each(function () {
            ...
            var course_image = `fileUpload-${++fileUploadCount}`;

            // Creates HTML content for the file upload area.
            var fileDivContent = `
                <label for="${course_image}" class="file-upload image-upload__box">
                    ...
                    <input type="file" id="${course_image}" name="course_image" multiple hidden />
                </label>
            `;
