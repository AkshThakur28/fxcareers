                ...
                <div class="row">
                    <div class="col-lg-6 align-self-center">
                        <div class="login_form">
                            ...
                            <form action="<?= base_url('admin/auth/login') ?>" class="mt-4" method="POST">
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3 ">
                                            ...
                                            <div class="position-relative">
                                                ...
                                                <img src="public/assets/img/login_mail.png"
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3 ">
                                            ...
                                            <div class="position-relative">
                                                ...
                                                <img src="public/assets/img/login_pas.png" width="30px" style="    z-index: 9; right: 10px !important; position: absolute;top: 10px !important;
    width: 24px;" class="  position-absolute top-0 end-0" alt="">
                                            </div>
                                        </div>
                                    ...
                                    <div class="col">
                                        <p class="text-secondary mt-3">
                                            ...
                                            or
                                            <a href="<?= base_url("forgot-password") ?>" class="text-primary">Forgot
                                                Password</a>
                                        </p>
                                    </div>
                    ...
                    <div class="col-lg-6 text-center">
                        <img src="public/assets/img/login_img.png" class="w-75" alt="">
                    </div>
                </div>
            </div>
                        ...
                        <div class="cta_right">
                            ...
                            <div class="download_point_wraper d-md-flex ">
                                <ul class="list-inline">
                                    <li class=" text-black mt-4"> <img src="public/assets/img/black_tick.svg"
