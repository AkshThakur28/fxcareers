                ...
                <div class="row">
                    <div class="col-lg-6 align-self-center">
                        <div class="login_form">
                            ...
                            <h2 class="text-white">Verify OTP</h2>
                            ...
                            <form action="<?= base_url('admin/auth/verify_otp') ?>" method="POST" class="mt-4">
                                <div class="row">
                                    <div class="col-md-12 ">
                                        <div class="mb-3 ">
                                            ...
                                            <div class="position-relative">
                                                <input type="number" class="form-control" name="otp" id="otp"
                                                    aria-describedby="helpId" required placeholder="Enter OTP" />
                                                <img src="<?= base_url() ?>public/assets/img/login_pas.png" width="30px"
                                                    style="z-index: 9; right: 10px !important; position: absolute;top: 10px !important;
