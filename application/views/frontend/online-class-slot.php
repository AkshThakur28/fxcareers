...
$onlineBasic = $this->Detail_Model->course_onlinedtl($id);
                           ...
                           <div class="row">
                              <div class="col-lg-6">
                                 <div class="it-signup-input mb-20">
                                    <input type="text" readonly name="course_name" value="<?= $row->course_name ?>">
                                 </div>
                              </div>
                              <div class="col-lg-6">
                                 <div class="it-signup-input mb-20">
                                    <input type="text" readonly name="price" value="<?= $row->price ?>>
                                 </div>
                              </div>
                              <div class="col-lg-6">
                                 <div class="it-signup-input mb-20">
                                    <input type="text" readonly name="duration" value="<?= $row->duration ?>>
                                 </div>
                              </div>
                              <div class="col-lg-6">
                                 <div class="it-signup-input mb-20">
                                    <input type="text" readonly name="username" value="<?= $row->username ?>>
                                 </div>
                              </div>
                           </div>
                        </div>
