...
<main>
        ...
        <div class="col-md-12">
          <div class="it-breadcrumb-content z-index-3 text-center">
            <div class="it-breadcrumb-title-box">
              <h3 class="it-breadcrumb-title">Enquiry Form</h3>
            </div>
  ...
  <div class="it-contact__area pt-120 pb-120 ">
    <div class="container">
      <div class="it-contact__wrap fix z-index-3 p-relative step-form"
        ...
        <div class="row align-items-end">
          ...
          <div class="mx-auto container">
            ...
            <!-- Progress Form -->
            <form id="progress-form" class="progress-form" action="<?php echo site_url('website/submit'); ?>"
              method="post" lang="en" novalidate>
              ...
              <section id="progress-form__panel-1" role="tabpanel" aria-labelledby="progress-form__tab-1" tabindex="0"
                ...
                <div class="row">
                  ...
                  <div class="mt-3 col-md-6 form__field">
                    ...
                    <input id="email_address" type="email" name="email_address" autocomplete="email" inputmode="email"
                      required class="zoom-in">
                  </div>
                ...
                <div class="d-flex align-items-center mtt-5">
                  <button type="button" id="continueButton" class="it-btn " data-action="next">
                    Continue
                  </button>
                </div>
              </section>
                ...
                <div class="row">
                  <div class="col-md-7">
                    <div class="mt-3 form__field">
                      ...
                      <div for="address-state" class="prefered-topics" data-toggle="prefered-topics">
                  ...
                  <div class="col-md-5 " style="margin-top: 3rem;">
                    <div class="mt-3 form__field">
                      ...
                      <select id="address_state" name="address_state" autocomplete="shipping address-level1"
              ...
              <section id="progress-form__panel-3" role="tabpanel" aria-labelledby="progress-form__tab-3" tabindex="0"
                ...
                <div class="row mt-4">
                  ...
                  <div class="mt-3 col-md-6 form__field">
                    ...
                    <input id="referal_email_address" type="email" name="referal_email_address" autocomplete="email"
                      inputmode="email" class="zoom-in">
                  </div>
                  ...
                  <div class="mt-3  col-md-6 form__field">
                    ...
                    <input id="referal_phone_number" type="tel" name="referal_phone_number" autocomplete="tel"
                      inputmode="tel" class="zoom-in">
                  </div>
                </div>
                ...
                <div class="mt-3 form__field">
                  ...
                  <textarea id="product-feedback" name="product_feedback" rows="5" class="py-2"
                    class="zoom-in"></textarea>
                </div>
              ...
              <section id="progress-form__panel-4" role="tabpanel" aria-labelledby="progress-form__tab-4" tabindex="0"
                hidden class="mtt-5">
                <form id="questionsForm" onsubmit="return validateForm()" method="POST">
                  ...
                  foreach ($questions as $question): ?>
                    <div class="mb-4">
                      <p class="fw-semibold"><?php echo $question->question; ?></p>
                      <div class="row">
                            ...
                            <div class="col-lg-6">
                              <?php if ($question->answer1 != ''): ?>
                                <div class="d-flex align-items-center radio-input">
                                  <input type="checkbox" name="answers[<?php echo $question->id; ?>]" value="1"
                                    required><?php echo $question->answer1; ?>
                                </div><br>
                              <?php endif; ?>
                            </div>
                            <div class="col-lg-6">
                              <?php if ($question->answer2 != ''): ?>
                                <div class="d-flex align-items-center radio-input">
                                  <input type="checkbox" name="answers[<?php echo $question->id; ?>]" value="2"
                                    required><?php echo $question->answer2; ?>
                                </div><br>
                              <?php endif; ?>
                            </div>
                            <div class="col-lg-6">
                              <?php if ($question->answer3 != ''): ?>
                                <div class="d-flex align-items-center radio-input">
                                  <input type="checkbox" name="answers[<?php echo $question->id; ?>]" value="3"
                                    required><?php echo $question->answer3; ?>
                                </div><br>
                              <?php endif; ?>
                            </div>
                            <div class="col-lg-6">
                              <?php if ($question->answer4 != ''): ?>
                                <div class="d-flex align-items-center radio-input">
                                  <input type="checkbox" name="answers[<?php echo $question->id; ?>]" value="4"
                                    required><?php echo $question->answer4; ?>
                                </div>
                              <?php endif; ?>
                            </div>
                          </div>
                  ...
                  <div class="d-flex gap-4 mtt-5">
                    ...
                    <button type="submit" name="submit" class="it-btn" data-action="next">
                      Continue
                    </button>
                  </div>
                </form>
              ...
              <!-- <section id="progress-form__panel-5" role="tabpanel" aria-labelledby="progress-form__tab-5" tabindex="0" class="py-5" hidden>
                <div class="mt-3 form__field text-center ">
                  ...
                  <div class="radial-progress m-auto" data-score="4">
                    ...
                    <div class="inset"><span class='big'><?php echo $db_score; ?></span> <span class='little'>/ 5</span></div>
                  </div>
...
<script>
  $(document).ready(function () {
    $('#continueButton').click(function () {
      ...
      $.ajax({
        url: '<?php echo base_url('website/append_insert'); ?>',
        type: 'POST',
        data: formData,
