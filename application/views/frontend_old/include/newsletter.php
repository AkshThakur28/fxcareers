...
<div class="it-newsletter-area it-newsletter-height fix p-relative theme-bg" id="it-newsletter">
      ...
      <div class="container">
         <div class="row">
            ...
            <div class="col-xl-6 col-lg-6 col-md-6">
               ...
               <form action="<?= base_url('admin/subscriber/newsletter_data_submit') ?>" method="post">
                  <input type="email" name="subscriber_email" placeholder="Enter your email:">
                  <button class="it-btn black-bg" type="submit" name="submit" value="submit"><span>subscribe now</span></button>
                  </form>
               </div>
            </div>
         </div>
