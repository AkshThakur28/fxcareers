<main>
            ...
            <div class="col-md-12">
               <div class="it-breadcrumb-content z-index-3 text-center">
                  <div class="it-breadcrumb-title-box">
                     <h3 class="it-breadcrumb-title">SELF LEARN </h3>
                  </div>
   ...
   <div class="it-course-area p-relative grey-bg pt-120 pb-120">
      <div class="container">
         <div class="row">
         <?php foreach($recorded_detail_view as $row):?>
         <div class="col-xl-4 col-lg-4 col-md-6 mb-30">
               <div class="it-course-item">
                  <div class="it-course-thumb mb-20 p-relative">
                     <a href="<?=base_url()?>recorded-detail/<?=str_replace(' ','-',strtolower($row->course_name));?>"><img src="<?=base_url('uploads/course/').$row->course_image;?>" alt="image"></a>
                  ...
                  <div class="it-course-content">
                     ...
                     <h4 class="it-course-title pb-5"><a href="<?=base_url()?>recorded-detail/<?=str_replace(' ','-',strtolower($row->course_name));?>"><?=$row->course_name?></a></h4>
                     ...
                     <div class="it-course-price-box d-flex justify-content-between">
                        ...
                        <a href="<?=base_url()?>recorded-detail/<?=str_replace(' ','-',strtolower($row->course_name));?>"><i class="fa-light fa-cart-shopping"></i>Buy Course</a>
                     </div>
                  </div>
               </div>
            </div>
