...
<head>
   ...
   <title>Get the Best Currency Trading Education - FXCareers</title>
...
<body>
      ...
      <div class="itoffcanvas">
         ...
         <div class="itoffcanvas__info">
            ...
            <div class="it-info-wrapper mb-20 d-flex align-items-center">
               ...
               <div class="itoffcanvas__info-address">
                  <span>Phone</span>
                  <a href="tel:8929144243">(+91) 8929144243</a>
               </div>
            </div>
            <!-- <div class="it-info-wrapper mb-20 d-flex align-items-center">
               <div class="itoffcanvas__info-icon">
                  ...
                  <div class="col-xl-4 col-lg-4 col-md-7 col-sm-8 d-none d-sm-block">
                     <div class="it-header-2-top-right text-end">
                        <ul>
                              ...
                              <div id="it-header-2-lang" class="it-header-2-lang d-none d-sm-block">
                                 <ul>
                                    <li class="d-inline-block ">
                                       <a href="javascript:void(0)" class="book-demo">
                                          Book A Demo
                                       </a>
                           ...
                           <!-- <li>
                                 <a href="#" class="book-demo">Book Free Demo <i class=" book-demo fa-solid f
                                 a-arrow-right"></i></a>
                     ...
                     <div class="row align-items-center">
                        <div class="col-xl-2 col-6">
                           <div class="it-header-2-logo" style="width: 70%;">
                              <a href="<?= base_url() ?>"><img src="<?= base_url() ?>public/web/assets/img/logo/logo.png"
                                    alt="" style="max-width: 136px;"></a>
                           </div>
                        </div>
                        <div class="col-xl-7 d-none d-xl-block">
                           <div class="it-header-2-main-menu text-center">
                              <nav class="it-menu-content">
                                 <ul>
                                    ...
                                    <li><a href="<?= base_url() ?>trade-idea">Trade Idea</a></li>
                  ...
                  <div class="col-xl-6 col-lg-6">
                     ...
                     <div class="it-signup-wrap">
                        ...
                        <div class="it-signup-btn mb-40">
                           <input type="submit" name="submit" class="it-btn large">
   ...
   <footer>
      ...
      <div class="it-footer-area it-footer-bg black-bg pt-120 pb-70"
         data-background="<?= base_url() ?>public/web/assets/img/footer/bg-1-1.jpg">
         <div class="container">
            <div class="row">
               <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 mb-50">
                  <div class="it-footer-widget footer-col-1">
                     <div class="it-footer-logo pb-25">
                        <a href="index-html"><img src="<?= base_url() ?>public/web/assets/img/logo/logo-white.png" alt=""
                              width="40%;"></a>
                     </div>
                     <div class="it-footer-text pb-5">
                        <p>Interdum velit laoreet id donec ultrices <br> tincidunt arcu. Tincidunt tortor aliquam nulla
                           facilisi cras fermentum odio eu.</p>
                     </div>
               ...
               <div class="col-xl-2 col-lg-4 col-md-6 col-sm-6 mb-50">
                  <div class="it-footer-widget footer-col-3">
                     ...
                     <div class="it-footer-list">
                        ...
                        <ul class="">
                           <li><a href="<?= base_url() ?>about-us"><i class="fa-regular fa-angle-right"></i> About Us</a>
                           </li>
                           <li><a href="<?= base_url() ?>trade-idea"><i class="fa-regular fa-angle-right"></i>Trade
                                 Idea</a></li>
                           <li><a href="<?= base_url() ?>gallery"><i class="fa-regular fa-angle-right"></i> Gallery</a>
                           </li>
                           <li><a href="<?= base_url() ?>e-books"><i class="fa-regular fa-angle-right"></i> E-Books</a>
                           </li>
