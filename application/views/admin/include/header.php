...
<head>
    ...
    <!-- Favicon -->
    <link rel="icon" href="<?= base_url() ?>public/admin/assets/images/brand-logos/favicon.png" type="image/x-icon">
    ...
    <!-- Style Css -->
    <link href="<?= base_url() ?>public/admin/assets/css/styles.css" rel="stylesheet">
    ...
    <!-- Simplebar Css -->
    <link href="<?= base_url() ?>public/admin/assets/libs/simplebar/simplebar.min.css" rel="stylesheet">

    <!-- Color Picker Css -->
    <link rel="stylesheet" href="<?= base_url() ?>public/admin/assets/libs/flatpickr/flatpickr.min.css">
    <link rel="stylesheet" href="<?= base_url() ?>public/admin/assets/libs/%40simonwep/pickr/themes/nano.min.css">

    <!-- Choices Css -->
    <link rel="stylesheet"
        href="<?= base_url() ?>public/admin/assets/libs/choices.js/public/assets/styles/choices.min.css">
    ...
    <!-- Auto Complete CSS -->
    <link rel="stylesheet"
        href="<?= base_url() ?>public/admin/assets/libs/%40tarekraafat/autocomplete.js/css/autoComplete.css">
    <!-- End::Styles -->
    <link rel="stylesheet" href="https://cdn.datatables.net/1.12.1/css/dataTables.bootstrap5.min.css">
    <link rel="stylesheet" href="https://cdn.datatables.net/responsive/2.3.0/css/responsive.bootstrap.min.css">
    <link rel="stylesheet" href="https://cdn.datatables.net/buttons/2.2.3/css/buttons.bootstrap5.min.css">
    <link rel="stylesheet" href="<?= base_url() ?>public/admin/assets/libs/quill/quill.snow.css">

    <!-- Swiper CSS -->
    <link rel="stylesheet" href="<?= base_url() ?>public/admin/assets/libs/swiper/swiper-bundle.min.css">
                    ...
                    <div class="header-element">
                        <div class="horizontal-logo">
                            <a href="<?= base_url() ?>" class="header-logo">
                                <img src="<?= base_url() ?>public/admin/assets/images/brand-logos/desktop-logo.png"
                                    alt="logo" class="desktop-logo">
                                <img src="<?= base_url() ?>public/admin/assets/images/brand-logos/toggle-dark.png"
                                    alt="logo" class="toggle-dark">
                                <img src="<?= base_url() ?>public/admin/assets/images/brand-logos/desktop-dark.png"
                                    alt="logo" class="desktop-dark">
                                <img src="<?= base_url() ?>public/admin/assets/images/brand-logos/toggle-logo.png"
                                    alt="logo" class="toggle-logo">
                                <img src="<?= base_url() ?>public/admin/assets/images/brand-logos/toggle-white.png"
                                    alt="logo" class="toggle-white">
                                <img src="<?= base_url() ?>public/admin/assets/images/brand-logos/desktop-white.png"
                ...
                <ul class="header-content-right">
                    ...
                    <!-- <li class="header-element country-selector dropdown">
                        ...
                        <ul class="main-header-dropdown dropdown-menu dropdown-menu-end" data-popper-placement="none">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between">
                                        <div class="d-flex align-items-center">
                                            <span class="avatar avatar-rounded avatar-xs lh-1 me-2">
                                                <img src="<?= base_url() ?>public/admin/assets/images/flags/us_flag.jpg"
                                                    alt="img">
                                            </span>
                                            English
                                        </div>
                            ...
                            <li>
                                <a class="dropdown-item d-flex align-items-center" href="javascript:void(0);;">
                                    <span class="avatar avatar-rounded avatar-xs lh-1 me-2">
                                        <img src="<?= base_url() ?>public/admin/assets/images/flags/spain_flag.jpg"
                                            alt="img">
                                    </span>
                                    español
                                </a>
                            ...
                            <li>
                                <a class="dropdown-item d-flex align-items-center" href="javascript:void(0);;">
                                    <span class="avatar avatar-rounded avatar-xs lh-1 me-2">
                                        <img src="<?= base_url() ?>public/admin/assets/images/flags/french_flag.jpg"
                                            alt="img">
                                    </span>
                                    français
                                </a>
                            ...
                            <li>
                                <a class="dropdown-item d-flex align-items-center" href="javascript:void(0);;">
                                    <span class="avatar avatar-rounded avatar-xs lh-1 me-2">
                                        <img src="<?= base_url() ?>public/admin/assets/images/flags/uae_flag.jpg"
                                            alt="img">
                                    </span>
                                    عربي
                                </a>
                            ...
                            <li>
                                <a class="dropdown-item d-flex align-items-center" href="javascript:void(0);;">
                                    <span class="avatar avatar-rounded avatar-xs lh-1 me-2">
                                        <img src="<?= base_url() ?>public/admin/assets/images/flags/germany_flag.jpg"
                                            alt="img">
                                    </span>
                                    Deutsch
                                </a>
                            ...
                            <li>
                                <a class="dropdown-item d-flex align-items-center" href="javascript:void(0);;">
                                    <span class="avatar avatar-rounded avatar-xs lh-1 me-2">
                                        <img src="<?= base_url() ?>public/admin/assets/images/flags/china_flag.jpg"
                                            alt="img">
                                    </span>
                                    中国人
                                </a>
                            ...
                            <li>
                                <a class="dropdown-item d-flex align-items-center" href="javascript:void(0);;">
                                    <span class="avatar avatar-rounded avatar-xs lh-1 me-2">
                                        <img src="<?= base_url() ?>public/admin/assets/images/flags/italy_flag.jpg"
                                            alt="img">
                                    </span>
                                    Italiano
                                </a>
                            ...
                            <li>
                                <a class="dropdown-item d-flex align-items-center" href="javascript:void(0);;">
                                    <span class="avatar avatar-rounded avatar-xs lh-1 me-2">
                                        <img src="<?= base_url() ?>public/admin/assets/images/flags/russia_flag.jpg"
                                            alt="img">
                                    </span>
                                    Русский
                                </a>
                            ...
                            <ul class="list-unstyled mb-0" id="header-notification-scroll">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="pe-2 lh-1">
                                            <span class="avatar avatar-md avatar-rounded bg-primary">
                                                <img src="<?= base_url() ?>public/admin/assets/images/faces/1.jpg"
                                                    alt="user1">
                                            </span>
                                        </div>
                                        <div class="flex-grow-1 d-flex align-items-center justify-content-between">
                                            <div>
                                                <p class="mb-0 fw-medium"><a href="<?= base_url() ?>chat.html">New
                                                        Messages</a></p>
                                                <div
                                ...
                                <li class="dropdown-item">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="flex-grow-1 d-flex align-items-center justify-content-between">
                                            <div>
                                                <p class="mb-0 fw-medium"><a href="<?= base_url() ?>chat.html">Order
                                                        Updates</a></p>
                                                <div
                                                    class="text-muted fw-normal fs-12 header-notification-text text-truncate">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="pe-2 lh-1">
                                            <span class="avatar avatar-md bg-orange avatar-rounded">
                                                <img src="<?= base_url() ?>public/admin/assets/images/faces/10.jpg"
                                                    alt="user1">
                                            </span>
                                        </div>
                                        <div class="flex-grow-1 d-flex align-items-center justify-content-between">
                                            <div>
                                                <p class="mb-0 fw-medium"><a href="<?= base_url() ?>chat.html">Comment on
                                                        Post</a></p>
                                                <div
                                                    class="text-muted fw-normal fs-12 header-notification-text text-truncate">
                                ...
                                <li class="dropdown-item">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="flex-grow-1 d-flex align-items-center justify-content-between">
                                            <div>
                                                <p class="mb-0 fw-medium"><a href="<?= base_url() ?>chat.html">Follow
                                                        Request</a></p>
                                                <div
                                                    class="text-muted fw-normal fs-12 header-notification-text text-truncate">
                                ...
                                <li class="dropdown-item">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="flex-grow-1 d-flex align-items-center justify-content-between">
                                            <div>
                                                <p class="mb-0 fw-medium"><a href="<?= base_url() ?>chat.html">Exclusive
                                                        Offers</a></p>
                                                <div
                                                    class="text-muted fw-normal fs-12 header-notification-text text-truncate">
                    ...
                    <li class="header-element dropdown">
                        ...
                        <a href="javascript:void(0);;" class="header-link dropdown-toggle" id="mainHeaderProfile"
                            ...
                            <div class="d-flex align-items-center">
                                <div>
                                    <img src="<?= base_url() ?>public/admin/assets/images/faces/15.jpg" alt="img"
                        ...
                        <ul class="main-header-dropdown dropdown-menu pt-0 overflow-hidden header-profile-dropdown dropdown-menu-end"
                            ...
                            <li>
                                <div class="dropdown-item text-center border-bottom">
                                    ...
                                    <span class="d-block fs-12 text-muted"><?= $role ?></span>
                                </div>
                            </li>
                            <li><a class="dropdown-item d-flex align-items-center" href="<?= base_url('admin/profile/view_profile') ?>"><i
                                        class="fe fe-user p-1 rounded-circle bg-primary-transparent me-2 fs-16"></i>My
                                    Profile</a></li>
                            ...
                            <li><a class="dropdown-item d-flex align-items-center"
                                    href="<?= base_url('admin/auth/logout') ?>"><i
